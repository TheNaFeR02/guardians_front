...
export default function VillainInfo({ image, backgroundImage, name, description }: { image: string | undefined, backgroundImage: string | undefined, name: string | undefined, description: string | undefined }) {
