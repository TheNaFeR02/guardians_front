...
export default function DeleteHeroAlert({ id, deleteCard }: { id: number, deleteCard: () => void }) {
  ...
  async function deleteHero() {
    // console.log(id);
      ...
      await delHero(id, session?.user.accessAPIToken);
      deleteCard(); 
      ...
      <AlertDialog >
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. This will permanently delete your hero
              and remove your data from our servers.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
            <AlertDialogAction onClick={deleteHero}>Continue</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
    </>
